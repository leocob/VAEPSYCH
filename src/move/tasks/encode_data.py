...
def encode_data(config: DataConfig):
    ...
    for dataset_name in config.categorical_names:
        ...
        names, values, data = io.read_tsv(filepath, sample_names, input_type = "categorical", p = 0.01, config)
    ...
    for input_config in config.continuous_inputs:
        ...
        names, values, data = io.read_tsv(filepath, sample_names, input_type = "continuous", p = 0.01, config)
